...
import { StyledFront } from './styles';
      ...
      <StyledFront>
        ...
        <div className="white" id="curriculum">
          ...
          <p className="centered">
            ...
            country, professional scientists, and community members.
          </p>
          <Program />
        </div>
        ...
        <div className="greyOuter">
          <div className="greyInner doubled">
            <div>
              <img src="/content/teachers/grace-church-school.png" />
            </div>
            <div className="stretchedBlockForTwo">
              <div>
                ...
                <p>
                  MindHive was first launched in March of 2020 as part of a
                  pilot implementation with 17 Environmental Science students in
