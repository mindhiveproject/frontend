      ...
      <div>
        <StyledTask>
          ...
          <ContainerOnlyForStudents>
            <fieldset>
              <h3>
                If you’ve already participated in this study, you can proceed to
                the next step – creating your own research study. (If you’re in
                a class, don’t proceed until the teacher has given the green
                light)
              </h3>
              <StyledButtons>
                <Link
