...
function getDefaultAllowAttributeValue() {
  ...
  const featurePolicyAllowedFeatures =
    ((_a = document.featurePolicy) === null || _a === void 0
      ? void 0
      : _a.allowedFeatures) && document.featurePolicy.allowedFeatures();
  if (featurePolicyAllowedFeatures) {
    return featurePolicyAllowedFeatures
      .filter(
        x =>
          ['display-capture', 'document-domain', 'encrypted-media'].indexOf(
            x
          ) === -1
      )
      .join(';');
...
function loadDefaultSettings(opts, el) {
  ...
  return {
    ...
    src:
      (_c =
        (_b =
          (_a = opts.src) !== null && _a !== void 0
            ? _a
            : el.getAttribute('src')) !== null && _b !== void 0
          ? _b
          : window.starboardEmbedIFrameSrc) !== null && _c !== void 0
        ? _c
    ...
    sandbox:
      (_f =
        (_e = opts.sandbox) !== null && _e !== void 0
          ? _e
          : el.getAttribute('sandbox')) !== null && _f !== void 0
        ? _f
    ...
    allow:
      (_h =
        (_g = opts.allow) !== null && _g !== void 0
          ? _g
          : el.getAttribute('allow')) !== null && _h !== void 0
        ? _h
        : getDefaultAllowAttributeValue(),
    onNotebookReadySignalMessage:
      (_j = opts.onNotebookReadySignalMessage) !== null && _j !== void 0
        ? _j
        : function() {},
    onContentUpdateMessage:
      (_k = opts.onContentUpdateMessage) !== null && _k !== void 0
        ? _k
        : function() {},
    onSaveMessage:
      (_l = opts.onSaveMessage) !== null && _l !== void 0 ? _l : function() {},
    onMessage:
      (_m = opts.onMessage) !== null && _m !== void 0 ? _m : function() {},
    onUnsavedChangesStatusChange:
      (_o = opts.onUnsavedChangesStatusChange) !== null && _o !== void 0
        ? _o
        : function() {},
    notebookContent: opts.notebookContent,
    preventNavigationWithUnsavedChanges:
      (_p = opts.preventNavigationWithUnsavedChanges) !== null && _p !== void 0
        ? _p
        : false,
  };
}
class StarboardEmbed extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (this.options.preventNavigationWithUnsavedChanges) {
      ...
      window.addEventListener(
        'beforeunload',
        this.unsavedChangesWarningFunction
      );
    }
  ...
  sendMessage(message) {
    ...
    this.hasReceivedReadyMessage.promise.then(() => {
      let _a;
      let _b;
      return (_b =
        (_a = this.iFrame) === null || _a === void 0
  ...
  updateDirty() {
    ...
    if (this.dirty !== priorDirtyState) {
      (_a = this.options) === null || _a === void 0
        ? void 0
        : _a.onUnsavedChangesStatusChange(this.dirty);
    }
  }
