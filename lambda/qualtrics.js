...
exports.handler = /*#__PURE__*/function () {
  var _ref = Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event, context) {
    var serverUrl, _event$headers, user, template, task, study, policy, data, metadata, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$headers = event.headers, user = _event$headers.user, template = _event$headers.template, task = _event$headers.task, study = _event$headers.study, policy = _event$headers.policy;
            data = JSON.parse(event.body);
            metadata = {
              id: Object(uuid__WEBPACK_IMPORTED_MODULE_2__["v1"])(),
              payload: 'full'
            };
            console.log('user, template, task, study, policy', user, template, task, study, policy);
            _context.next = 7;
            return axios({
              method: 'post',
              url: serverUrl,
